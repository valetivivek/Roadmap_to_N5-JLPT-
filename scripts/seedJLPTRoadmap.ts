...
// Your comprehensive 20-week JLPT N5 roadmap
const jlptN5Roadmap = [
  {
    week: 1,
    ...
    days: [
      {
        ...
        tasks: [
          { label: "Learn hiragana あ (a)", category: "hiragana", points: 1, resources: [
            ...
            { title: "Hiragana Writing Practice", url: "https://www.tofugu.com/japanese/learn-hiragana/", kind: "doc", description: "Practice sheets for hiragana" }
          ]},
          ...
          { label: "Basic greetings: おはよう, こんにちは", category: "vocab", points: 1, resources: [
            { title: "JapanesePod101 Greetings", url: "https://www.youtube.com/playlist?list=PL9987A659670D60E0", kind: "video", description: "Learn basic Japanese greetings" }
          ]}
        ]
      },
      {
  ...
  // Continue with weeks 3-20 following the same pattern...
  // For brevity, I'll add a few more key weeks
  {
    week: 3,
    ...
    days: [
      ...
      // Continue with more days for particles...
    ]
  }
]

async function seedJLPTRoadmap() {
  console.log('🌱 Starting JLPT N5 roadmap seeding with your comprehensive plan...')
  ...
  try {
    ...
    jlptN5Roadmap.forEach((week, index) => {
      weekEntries.push({
        title: week.title,
        order: week.week
      })
    ...
    jlptN5Roadmap.forEach((week, weekIndex) => {
    ...
    // 7. Summary
    console.log('\n🎉 JLPT N5 Roadmap seeding completed successfully!')
    console.log(`📊 Summary:`)
